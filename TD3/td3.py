...
from policies import Actor, CnnPolicy, MlpPolicy, MultiInputPolicy, TD3Policy
            ...
            if self._n_updates % self.policy_delay == 0:
                ...
                # if self.step >= self.total_step - self.trace_num:
                    ...
                    for name, param in self.actor_target.named_parameters():
                        if "weight" in name or "bias" in name:
                            self.actor_target.Trace["name"].append(name)
                            self.actor_target.Trace["weight"].append(param.data)
